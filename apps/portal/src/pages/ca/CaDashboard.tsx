...
export function CaDashboard() {
  ...
  const healthColor = dashboard.average_health_score >= 80 ? 'text-green-600' : dashboard.average_health_score >= 60 ? 'text-yellow-600' : 'text-red-600';
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{dashboard.total_clients}</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{dashboard.active_filings}</p>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-red-600 mt-2">{dashboard.overdue_documents}</p>
            </div>
        ...
        <div className={`bg-white rounded-lg border border-gray-200 p-6`}>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold mt-2 ${healthColor}`}>{dashboard.average_health_score}%</p>
            </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="text-4xl font-bold text-red-600">{dashboard.recent_exceptions}</div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="text-4xl font-bold text-orange-600">{dashboard.upcoming_deadlines}</div>
